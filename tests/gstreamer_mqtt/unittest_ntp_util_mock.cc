...
/**
 * @brief Initialize hostent.
 */
static void _hostent_init (struct hostent *host)
{
 ...
 * @brief Free hostent.
 */
static void _hostent_free (struct hostent *host)
{
  g_free (host->h_name);
 ...
 */
TEST (NtpUtilMockGetEpoch, Normal_p)
{
  int64_t ret;
  ...
  _hostent_init (&temp_hostent);

  EXPECT_CALL (*mockInstance, gethostbyname(_))
      .Times(1).WillOnce(Return((struct hostent *)&temp_hostent));
 ...
 */
TEST (NtpUtilMockGetEpoch, GetHostNameFail_n)
{
  int64_t ret;
 ...
 */
TEST (NtpUtilMockGetEpoch, ConnectFail_n)
{
  int64_t ret;
  struct hostent temp_hostent;
 ...
 */
TEST (NtpUtilMockGetEpoch, writeFail_n)
{
  int64_t ret;
  struct hostent temp_hostent;
 ...
 */
TEST (NtpUtilMockGetEpoch, readFail_n)
{
  int64_t ret;
  struct hostent temp_hostent;
 ...
 * @brief Test for ntp util to get epoch.
 */
TEST (NtpUtilMockGetEpoch, ivalidTimestamp)
{
  int64_t ret;
  struct hostent temp_hostent;
